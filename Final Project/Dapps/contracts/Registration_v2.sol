...
// -------------------------------FUNCTIONS-------------------------------------
    ...
    function initializeRace (string _racename, int _price, string _country)  public returns(uint) {
    ...
    function addAthlete(string memory _name, uint _age, string _gender) public returns(uint){
